					...
					<div class="dgwltd-hero__content stack">
						...
						<?php if ( ! empty( $video ) && $has_video ) : ?>
							<div class="dgwltd-hero__play">
								<a class="dgwltd-button popup-trigger" data-popup-trigger="videoModal<?php echo $unique_id; ?>">
									<?php esc_html_e( 'Watch', 'dgwltd-plugin' ); ?>
...
<div 
 class="popup-modal" 
 data-popup-modal="videoModal<?php echo $unique_id; ?>"
 ...
 >
	...
	<h2 class="popup-modal__heading" data-modal-title id="dialog-title" tabindex="-1"><?php esc_html_e( 'Watch the video', 'dgwltd-plugin' ); ?></h2>
	<?php if ( $video_type == 'youtube' ) { ?>
		<iframe 
		id="youtube_player" 
		title="<?php esc_html_e( 'Video modal', 'dgwltd-plugin' ); ?>"
